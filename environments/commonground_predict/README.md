...
- `commonground_predict/data/train_synthetic.jsonl`: 150 seeded synthetic
  ...
  disjoint from every eval split. Select it with `split="train"`; the eval
  splits and their published floors stay frozen. Same-seed regeneration is
  byte-identical.
...
```toml
[[env]]
id = "charliethompson/commonground-predict"
