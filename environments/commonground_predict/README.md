...
`commonground-predict` 0.2.5 is a deterministic native Verifiers v1 taskset
...
for evaluation or training. Release 0.2.5 uses seeded synthetic snapshots and
...
`commonground-predict` 0.2.5 and `commonground-elicit` 0.2.5 are the two Hub
release candidates.
