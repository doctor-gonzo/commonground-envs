...
Status: exact private Hub artifacts and the full model study are complete.
Public visibility, anonymous installation, and version-pinned public evaluation
...
- Both exact private Hub versions passed their integration actions and a fresh
  pull/install/load check. The pulled source archives retained the nested
...
| Public evaluation IDs | Pending public visibility and version-pinned trace publication |
